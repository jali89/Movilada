    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (fragment == null) {
            ...
            RoundRepository repository =
                    RoundRepositoryFactory.createRepository(getApplicationContext());
            Round round = repository.getRound(roundId);
            String tablero = round.getBoard().tableroToString();
            RoundFragment roundFragment = RoundFragment.newInstance(roundId,
                    round.getSecondPlayerName(), round.getTitle(), round.getSize(),
                    round.getDate(), tablero);
